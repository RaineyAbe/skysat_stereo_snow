...
def getparser():
    ...
    parser.add_argument('-coregdem_in_bundle_adjust',default=False,type=int,choices=[1,0],help='Whether to include coregdem in bundle adjust')
    parser.add_argument('-coregdem_uncertainty',default=10,type=float,help='uncertainty of the coreg DEM, used for weighting in bundle adjustment')
...
def main():
    ...
    coregdem_in_ba = args.coregdem_in_bundle_adjust
    coreg_dem_uncertainty = args.coregdem_uncertainty
    ...
    coreg_dem, ortho_dem, epsg_code = workflow.prepare_reference_elevations(coreg_dem, ortho_dem, multispec, bound_fn, 
                                                                            bound_buffer_fn, stable_surface_dir, 
                                                                            ndvi_threshold, ndsi_threshold, 
                                                                            coreg_stable_only=coreg_stable_only)
    ...
    if 4 in steps2run:
        ...
        workflow.bundle_adjustment(img_folder, ba_prefix, cam_gcp_directory, overlap_list=overlap_stereo_txt, 
                                   dem=coreg_dem, dem_in_ba=coregdem_in_ba, dem_uncertainty=coreg_dem_uncertainty, num_iter=2000, num_pass=2)
