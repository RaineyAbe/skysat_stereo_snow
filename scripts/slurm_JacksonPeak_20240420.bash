#!/bin/bash
#SBATCH -J JacksonPeak_20240420         # job name
#SBATCH -o output_JacksonPeak_20240420.o%j  # output and error file name (%j expands to jobID)
...
-outfolder "${base_dir}/study-sites/${site_name}/${date}" \
-orthodem $coregdem \
-coregdem $coregdem \
-coreg_stable_only 0 \
-coregdem_in_bundle_adjust 0 \
-coregdem_uncertainty 0 \
-ndvi_threshold 0.4 \
-ndsi_threshold 0.0 \
